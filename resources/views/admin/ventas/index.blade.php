...
@section('content')
    <div class="p-6 bg-gradient-to-br from-amber-100 via-orange-100 to-amber-200 min-h-screen">
        ...
        {{-- Header --}}
        <div class="flex justify-center items-center text-center mb-6 border-b pb-4">
        ...
        <div class="grid grid-cols-12 gap-6">
            ...
            <div class="col-span-8">
                ...
                {{-- Cards de productos --}}
                <div id="catalogo" class="grid grid-cols-3 gap-6">
                    @foreach ($productos as $producto)
                        <div class="producto-card bg-white rounded-2xl shadow-lg overflow-hidden border border-amber-200"
                            ...
                            <div
                                class="h-32 bg-gradient-to-tr from-amber-200 to-amber-400 flex items-center justify-center">
                                {{-- Imagen opcional --}}
                            </div>
                            <div class="p-4">
                                <h3 class="font-semibold text-lg text-amber-900">{{ $producto->nombre }}</h3>
            ...
            <div class="col-span-4">
                ...
                {{-- Extras --}} <div class="mt-6 space-y-3"> <button
                        class="w-full bg-amber-500 text-white py-2 rounded-lg hover:bg-amber-600 shadow">Ver
                        historial</button> <button
                        class="w-full bg-amber-800 text-white py-2 rounded-lg hover:bg-amber-900 shadow">Cobrado del
                        pedido</button> </div>
            </div>
        ...
        {{-- Pedidos en cocina --}}
        <div class="mt-10 bg-white shadow rounded-2xl p-6 border border-amber-200">
                ...
                @forelse($pedidos as $pedido)
                    <div class="border rounded-lg p-4 shadow-sm">
                        ...
                        <div class="flex justify-end">
                            <button class="bg-amber-700 text-white px-3 py-1 rounded-lg hover:bg-amber-800 text-sm">
                                Cobrar
                            </button>
                        </div>
                    </div>
    ...
    <script>
            ...
            function filtrarProductos(categoriaId) {
                document.querySelectorAll('.producto-card').forEach(card => {
                    card.style.display = (categoriaId === 'all' || card.dataset.categoria == categoriaId) ? 'block' :
                        'none';
                });
            }
