...
<div class="bg-gradient-to-b from-amber-50 to-orange-50 min-h-screen p-6 rounded-lg shadow">
    ...
    <div class="flex flex-wrap items-center gap-3 mb-6">
        ...
        <select class="px-4 py-2 border border-stone-300 rounded-lg focus:ring-2 focus:ring-amber-400">
        ...
        <button class="px-5 py-2 bg-stone-700 text-white rounded-lg shadow hover:bg-stone-800">Buscar</button>
    </div>
            ...
            <tbody class="text-stone-700">
                @foreach ($productos as $producto)
                    <tr class="border-t hover:bg-stone-50">
                        <td class="px-4 py-2">
                            <div class="w-12 h-12 bg-stone-200 rounded"></div> <!-- Aquí puedes poner la imagen real -->
                        </td>
                        ...
                        <td class="px-4 py-2">
                            @if($producto->estado ?? true) <!-- Suponiendo que tienes campo estado -->
                        ...
                        <td class="px-4 py-2 flex items-center gap-3">
                            ...
                            <!-- Eliminar -->
                            <form action="{{ route('productos.eliminar', $producto->idProducto) }}" method="POST" onsubmit="return confirm('¿Seguro que quieres eliminar este producto?');">
                                @csrf
                                @method('DELETE')
