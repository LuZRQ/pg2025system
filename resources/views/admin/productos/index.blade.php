...
<div class="bg-gradient-to-b from-amber-50 to-orange-50 min-h-screen p-6 rounded-lg shadow">
    ...
    {{-- Botones de crear producto/categoría --}}
            ...
            <div class="bg-white p-4 rounded-lg shadow hover:shadow-md transition">
                <div class="flex items-center gap-3 mb-2">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500">Bs. {{ number_format($producto->precio, 2) }}</p>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-3 mt-2">
                    <a href="{{ route('productos.ver', $producto->idProducto) }}" class="text-stone-600 hover:text-stone-800">
                        <i class="fas fa-eye"></i>
                    </a>
                    <a href="{{ route('productos.editar', $producto->idProducto) }}" class="text-blue-600 hover:text-blue-800">
