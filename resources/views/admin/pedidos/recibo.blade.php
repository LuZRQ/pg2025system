...
<div class="flex flex-col md:grid md:grid-cols-12 gap-6">
    ...
    <div class="w-full md:w-1/4 md:fixed md:left-0 md:top-0 md:h-screen 
        ...
        {{-- Botón de imprimir solo el ticket --}}
        <button id="btnPrint"
...
{{-- Script y estilos para impresión --}}
@push('scripts')
<style>
@media print {
    @page {
        margin: 0; /* eliminar márgenes de navegador */
    }
    body {
        margin: 0;
    }
    #ticket {
        ...
        max-width: 5cm;   /* ancho inicial, se ajusta con slider */
        padding: 0.5cm;
    }
}
</style>
...
// Imprimir solo el ticket y centrar ventana de impresión
